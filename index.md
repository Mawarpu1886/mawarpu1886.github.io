---
layout: "default"
title: "📧 tempik - Protect your identity with temporary emails"
description: "Host a disposable email service on Cloudflare Workers using D1 for storage and native email handling without a VPS or server costs."
---
...
- A registered domain name if you want to use a custom address for your emails.
...
- Testing website sign-up forms.
- Downloading free ebooks or whitepapers.
- Signing up for multiple service trials.
- Avoiding mailing list subscriptions.
- Preventing data leaks from third-party sites.
...
No, the service uses the free tier of Cloudflare Workers. You can deploy this at no cost unless you expect millions of emails per day.

Do I need to be a coder?
No. You only need to copy and paste the code into the Cloudflare dashboard. The setup takes about ten minutes for a new user.

Can I use my own domain?
Yes. Cloudflare allows you to link your own domain to the worker. This makes your email addresses look professional.

What happens to my emails after I close the tab?
The system deletes the messages after the expiration period. You cannot recover them once the system clears the storage.
